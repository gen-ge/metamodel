...
'''
    ...
    def show_build_summary(self) -> None:
        ...
        print(f"")
        print(f"📋 RELEASE AUTOMÁTICO (recomendado):")
        print(f"  make release-tag VERSION={self.version}")
        print(f"  # ↑ Cria tag e GitHub Actions faz release automaticamente!")
        print(f"")
        print(f"📋 RELEASE MANUAL (se necessário):")
        print(f"1. 📤 Envie arquivos para releases do GitHub")
        print(f"2. 🧪 Teste instalação em workspace limpo")
        print(f"")
